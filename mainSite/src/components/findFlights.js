            ...
            <div class="findticket">
                <form class="findticket-form">
                            ...
                            <td>
                                ...
                                {modal && (
                                    <div className='customer-quantity-modal'>
                                        <div>
                                            <img alt='...' src={Adult} width="25px" className='quantity-item' />
                                            <span className='quantity-item' style={{ "marginTop": "0px" }}>
                                                <div>Người lớn</div>
                                                <div>(từ 12 tuổi)</div>
                                            </span>
                                            <div className='quantity-item'>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => minusAdultQuantity()}><img alt='...' src={Minus} width="15px" /></button></span>
                                                <span style={{ "width": "30px", "textAlign": "center" }}>{adultQuantity}</span>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => addAdultQuantity()}><img alt='...' src={Add} width="15px" /></button></span>
                                            </div>
                                        </div>
                                        <div>
                                            <img alt='...' src={Child} width="20px" className='quantity-item' />
                                            <span className='quantity-item'>
                                                <div>Trẻ em</div>
                                                <div>(từ 2-12 tuổi)</div>
                                            </span>
                                            <div className='quantity-item'>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => minusChildQuantity()}><img alt='...' src={Minus} width="15px" /></button></span>
                                                <span style={{ "width": "30px", "textAlign": "center" }}>{childQuantity}</span>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => addChildQuantity()}><img alt='...' src={Add} width="15px" /></button></span>
                                            </div>
                                        </div>
                                        <div>
                                            <img alt='...' src={Baby} width="20px" className='quantity-item' />
                                            <span className='quantity-item'>
                                                <div>Em bé</div>
                                                <div>(dưới 2 tuổi)</div>
                                            </span>
                                            <div className='quantity-item'>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => minusBabyQuantity()}><img alt='...' src={Minus} width="15px" /></button></span>
                                                <span style={{ "width": "30px", "textAlign": "center" }}>{babyQuantity}</span>
                                                <span><button className='btnAdjustQuantity' type='button' onClick={() => addBabyQuantity()}><img alt='...' src={Add} width="15px" /></button></span>
                                            </div>
                                        </div>
                    ...
                    <Link to='/search-result' style={{ textDecoration: "none" }} >
                        <div class="line-button"><button class="btnFindticket" onClick={handleSaveSearchInfo}><img alt='...' src={SearchIcon} /><b>Tìm chuyến bay</b></button></div>
                    </Link>
                </form>
            </div>
            <div style={{ "display": "flex", "justifyContent": "center", "marginTop": "100px" }}>
                <img alt='...' src={Partnership} width="62%" />
            </div>
        </div>
    )
}
