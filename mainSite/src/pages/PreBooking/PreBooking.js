            ...
            <div className='prebooking-container'>
                ...
                <div className='prebooking-sub-container'>
                    <div className='prebooking-info'>
                        <div><img alt='...' src={SmallFlight} width="50px" />Hà Nội (HAN) <span><img alt='...' src={MockRightArrow} width="40px" /></span> Đà Nẵng (DAD)</div>
                    ...
                    <div className='prebooking-right-column'>
                        <div className='prebooking-supplement-info'>
                            <div className='prebooking-header-supplement-info'>
                                <div><span><img alt='...' src={Detail} width="40px" /></span>Thông tin bổ sung</div>
                            ...
                            <div className='prebooking-body-supplement-info'>
                                ...
                                <div class="prebooking-detail-refund" style={{ "margin": "0px", "padding": "0px" }}>
                                    <div><span><img alt='...' src={Checked} width="30px" /></span>Có hoàn tiền</div><br />
                                    <div style={{ "margin": "0px" }}><span><img alt='...' src={Checked} width="30px" /></span>Có áp dụng đổi lịch bay</div>
                                </div>
                            </div>
                        </div>
